...
If you need to install it on Plasma 6.5 or lower, I recommend you do it from here: https://github.com/vickoc911/org.kde.plasma.plasmadock
...
<details>
  ...
  sudo zypper refresh
  sudo zypper install plasmadock
  ```
</details>
<details>
  ...
  ```sh
  sudo dnf copr enable vcalles/plasmadock 
  sudo dnf install plasmadock
  ```
</details>

After installing the package, you just need to add the panel for plasmadock
...
![plasmadock](screenshot/plasmadock_1280.webp?raw=true "plasmadock")
